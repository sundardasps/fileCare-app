...
export function Navbar() {
  ...
  return (
    <Nav  className="mx-auto max-w-screen-xxl h-[4rem] rounded-none px-4 py-1 lg:px-8 lg:py-1 shadow-md  ">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        <div className=" gap-x-1">
          <Button
            variant="gradient"
            size="sm"
            className="flex lg:inline-block"
            onClick={() => pathname === "/" ? navigate('/login') : handleLogOut()}
          >
